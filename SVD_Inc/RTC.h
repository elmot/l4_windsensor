...
// control register
 struct {
      ...
      unsigned int ITSE: 1; // timestamp on internal event               enable
...
// tamper configuration register
 struct {
      ...
      unsigned int TAMP1IE: 1; // Tamper 1 interrupt enable
      unsigned int TAMP1NOERASE: 1; // Tamper 1 no erase
      unsigned int TAMP1MF: 1; // Tamper 1 mask flag
      unsigned int TAMP2IE: 1; // Tamper 2 interrupt enable
      unsigned int TAMP2NOERASE: 1; // Tamper 2 no erase
      unsigned int TAMP2MF: 1; // Tamper 2 mask flag
      unsigned int TAMP3IE: 1; // Tamper 3 interrupt enable
      unsigned int TAMP3NOERASE: 1; // Tamper 3 no erase
      unsigned int TAMP3MF: 1; // Tamper 3 mask flag
      unsigned int : 7; // Reserved
} TAMPCR;
...
// option register
 struct {
      unsigned int RTC_ALARM_TYPE: 1; // RTC_ALARM on PC13 output               type
      unsigned int RTC_OUT_RMP: 1; // RTC_OUT remap
